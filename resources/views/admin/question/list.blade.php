...
<!-- page content -->
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
              <!--Message From Ajax Response-->
              <div class="" role="alert" id="ajax-message">
                 <p id="msg"></p>
              </div>
              <!--------------------------------->
              <div class="clearfix"></div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div id="singleqn">
		                     ...
		                     <textarea class="form-control qns" placeholder="Enter Question Here" name= "question[]" readonly="readonly">{{$question->question}}</textarea></br>
		                     <div class="form-row options" id="options">
          		    					<div class="form-group col-md-3">
          							      
          							      <input type="text" class="form-control" placeholder="Option A" name="optA[]" readonly="readonly" value="{{$question->optA}}">
          		    					</div>
          							    <div class="form-group col-md-3">
          							      
          							      <input type="text" class="form-control" placeholder="Option B" name="optB[]" readonly="readonly" value="{{$question->optB}}">
          							    </div>
          							    <div class="form-group col-md-3">
          							      
          							      <input type="text" class="form-control" placeholder="Option C" name="optC[]" readonly="readonly" value="{{$question->optC}}">
          							    </div>
          							    <div class="form-group col-md-3">
          							       <input type="text" class="form-control" placeholder="Option D" name="optD[]" readonly="readonly" value="{{$question->optD}}">
          							    </div>
                          </div></br>
                          <input type="text" class="form-control ans" placeholder="Mention Correct Answer Or Option" name="answer[]" list="answer" readonly="readonly" value="{{$question->answer}}">
                          <datalist id="answer">
                          ...
                          </br><input type="checkbox" name="is_entry[]" disabled="disabled" id="entryQn" {{($question->is_entry == 1)?'checked':''}}/> Mark as Entry Type</br>
                          <button type="button" class="btn btn-primary" id="editQn">Edit Question</button>
                          <button type="button" class="btn btn-warning" id="delQn">Remove Question</button>
                          @if(Auth::user()->role == 'teacher')
                          <button type="button" class="btn btn-danger" >Request For Permanent Removal</button>
                          @endif
