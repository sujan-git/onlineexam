...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i>Administration<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a>Finalize Question</a>
                        <ul class="nav child_menu">
                            @if($subjects)
                            @foreach($subjects as $subj)
                            <li class="sub_menu"><a href="{{route('question.final',$subj->id)}}">{{$subj->name}}</a>
                            </li>
                            @endforeach
                            @endif
                          </ul>
                  ...
                  <li><a><i class="fa fa-file-text"></i>Question Design<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                        <li><a href="{{route('question')}}}">Question Setup</a>
                        <li><a>Question Preview<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            @if($subjects)
                            @foreach($subjects as $subj)
                            <li class="sub_menu"><a href="{{route('question.list',$subj->id)}}">{{$subj->name}}</a>
                            </li>
                            @endforeach
                            @endif
                          </ul>
                   ...
                   <li><a><i class="fa fa-edit"></i>Result<span class="fa fa-chevron-down"></span></a>
                    <!--<ul class="nav child_menu">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><form method="post"><a href="{{route('logout')}}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="fa fa-sign-out pull-right"></i> Log Out</a></form>
    ...
    <script src="{{asset('backend/build/js/linkclick.js')}}"></script>
	   @yield('scripts')
  </body>
</html>
